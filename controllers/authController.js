...
exports.login = catchAsync(async (req, res, next) => {
  ...
  // 2) Check if user exits && email and password is correct
...
exports.restrictTo =
  (...roles) =>
  (req, res, next) => {
    // roles ['admin', 'user', 'guide', 'lead-guide'] role = 'user'
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  // 2) Check if the token is valid, and there is user, set the new password
  if (!user) {
    return next(
